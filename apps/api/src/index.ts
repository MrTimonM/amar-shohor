...
import { log } from './log';
import { mailerConfigured, mailerStatus, verifyAccounts } from './mailer';
...
async function main() {
  ...
  // Not awaited: a slow or dead mail host must not hold up the server. Each
  // account's credentials are checked in the background and any failure is
  // logged with the usual cause.
  void verifyAccounts();
